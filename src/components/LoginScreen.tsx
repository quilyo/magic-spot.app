  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-2xl p-8 border border-gray-200">
          
          <h2 className="text-center text-gray-900 mb-6 font-bold font-normal">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isSignup && (
              <div className="flex items-start space-x-2 max-h-24 overflow-y-auto p-2 border border-gray-300 rounded-md bg-[rgb(246,246,246)]">
                <Checkbox
                  id="terms"
                ...
                <Label htmlFor="terms" className="text-sm text-gray-700 cursor-pointer leading-tight">
                   <a href="#" className="text-gray-900 underline hover:text-gray-700"></a>  <a href="#" className="text-gray-900 underline hover:text-gray-700"></a> I agree to the Terms and Conditions and Privacy Policy of this beta test. Parking spots state may not be accurate, this is a work in progress and we're happy you're part of it. Your email will be protected and never shared.
                </Label>
              </div>
            )}
